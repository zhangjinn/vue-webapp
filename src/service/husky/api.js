...
let orderApiPrefix = "http://husky.etmcn.com/order";
 //game
...
//execute
export const getExecute = (data, id = "") => {
...
export const getShopList = (data) => {
    const url = orderApiPrefix+'/commodity/list';
    return http.get(url,data);
};
/*
* 生成订单
...
export const getPayOrder = (data) => {
    const url = orderApiPrefix+'/order';
    return http.post(url,data);
};
/*
* 跳转至外部链接去支付
* */
export const goToPayPage = () => {
    return window.location.href = orgApiPrefix + '/pay/alipay/wap/merchantGotoPayPage';
};
/*
* 获取商品或课程详情
* @param {接口地址} userApiPrefix
* @param {接收参数} 商品id
* */
export const getOrderDetails = (id) => {
    const url = orderApiPrefix+'/commodity/' + id;
    return http.get(url);
};
