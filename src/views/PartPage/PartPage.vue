<template>
	<div class="part TaskDescribe">
		...
		<div class="header">
			<span class="title">Part1 知识应用</span>
...
<script>
	import { getMatchTaskPart } from "../../service/api.js";
	...
	export default {
		...
		methods: {
			...
			async getItemList(){
				...
				this.part = this.matchData[this.partIndex].part;
				this.topicData = this.matchData[this.partIndex].item;
