<template>
    <div class="completeInformation">
        ...
        <div class="saveBtn" @click="updata">
            <span>完成</span>
        </div>
        ...
        <van-popup v-model="isArea" position="top">
            <van-area :area-list="areaList" title="选择地区" @confirm="confirm"/>
        </van-popup>
    ...
    export default {
        ...
        created() {
            ...
            if (_this.user == undefined || _this.user == null) {
                ...
                getUserInfo({
                    ...
                    _this.user = res.data;
                    // setUser(localStorage.getItem("token"), localStorage.getItem("phone"), _this.user);
                    // 设置用户
                    setUser(_this.user)

                    // console.log(_this.user.person)
        ...
        methods: {
            ...
            confirm(v) {
                ...
                // console.log(v,this.choose_district,this.chooseValue)
            ...
            updata() { // 完成保存
                ...
                putPerson(_this.person, _this.user.person).then(function (res) {
                    Dialog.alert({
                        title: '',
                        message: '修改成功'
                    }).then(() => {
